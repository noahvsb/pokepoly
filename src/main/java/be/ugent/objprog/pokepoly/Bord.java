...
import be.ugent.objprog.pokepoly.tiles.TaxTile;
...
import be.ugent.objprog.pokepoly.tiles.card.Deck;
import be.ugent.objprog.pokepoly.tiles.corner.FreeParkingTile;
import be.ugent.objprog.pokepoly.tiles.corner.JailTile;
import be.ugent.objprog.pokepoly.tiles.corner.StartTile;
import be.ugent.objprog.pokepoly.tiles.possession.RailwayTile;
import be.ugent.objprog.pokepoly.tiles.possession.StreetTile;
import be.ugent.objprog.pokepoly.tiles.possession.UtilityTile;
import be.ugent.objprog.pokepoly.tiles.corner.GoToJailTile;
...
public class Bord extends BorderPane {
    ...
    public Bord() throws JDOMException, IOException {
        ...
        Document doc = new SAXBuilder().build(getClass().getResourceAsStream("pokepoly.xml"));
    ...
    private void addTilesToArray() throws IOException {
        ...
        for (int i = 0; i < 40; i++) {
            ...
            switch (type) {
                ...
                case "UTILITY" -> {
                    int cost = Integer.parseInt(tile.getAttributeValue("cost"));
                    tiles[pos] = new UtilityTile(id, cost, infoTile, this);
                }
