...
public class ChestTile implements Tile {
    ...
    public ChestTile(String id, int width, int height) throws IOException {
        this.id = id;
    ...
    public void createTile() throws IOException {
        ...
        imageView.setImage(new Image(Objects.requireNonNull(getClass().getResource("assets/chest.png")).toExternalForm()));
