...
public class ChanceTile implements Tile {
    ...
    public ChanceTile(String id, int width, int height) throws IOException {
        this.id = id;
    ...
    public void createTile() throws IOException {
        ...
        imageView.setImage(new Image(Objects.requireNonNull(getClass().getResource("assets/chance.png")).toExternalForm()));
